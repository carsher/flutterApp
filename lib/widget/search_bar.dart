...
class SearchBar extends StatefulWidget{
  ...
  const SearchBar({Key key, this.enabled=true, this.hideLeft, this.searchBarType=SearchBarType.normal, this.hint, this.defaultText, this.leftButtonClick, this.rightButtonClick, this.speakButtonClick, this.inputButtonClick, this.onChanged}) : super(key: key);
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          ...
          ),widget.speakButtonClick ):_wrapTap(
              Icon(
                Icons.clear,
                size: 22,
                color: widget.searchBarType == SearchBarType.normal?Colors.blue:Colors.grey,
